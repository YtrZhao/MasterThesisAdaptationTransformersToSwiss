...
def model_init():
    return AutoModelForSequenceClassification.from_pretrained("deepset/gbert-base", num_labels=4)
...
def main():
    ...
    trainer = Trainer(
        ...
        callbacks=[EarlyStoppingCallback(early_stopping_threshold=0.01, early_stopping_patience=6)],
    )
    ...
    model_dir=["deepset/gbert-base","GBert/MLM_archimob_subset","GBert/MLM_swiss_crawl_64k","GBert/MLM_swiss_crawl_full_new"]
    for i in range(4):
